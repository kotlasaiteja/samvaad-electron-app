...
import { getMeetingParticipantDetails } from '../actions';
...
import { setBaseURL, GET } from '../../dhanush/services';
...
class Welcome extends Component<Props, State> {
    ...
    setMeetingParticipantInfo(participantData) {
        ...
        const participantInfo = {
            ...
            emailRequired: participantData.emailRequired,
    ...
    _renderHeader() {
        ...
        return (<div>
            ...
            {/* <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', marginTop: '-4rem' }}>
                <span style={{ color: '#ffffff', fontSize: '1rem' }}>Or</span>
                <span style={{ marginTop: '2rem', fontSize: '1rem' }}>
                    <Button
                        appearance='primary'
                        onClick={() => this._renderHomePage()}
                        type='button'>
                        Sign In
                    </Button>
                </span>
...
function _mapStateToProps(state: Object) {
    return {
        ...
        // userDetails: state.welcome.userDetails,
