...
class Conference extends Component<Props, State> {
     ...
     */
    componentDidMount() {
        const samvaadURl = 'https://j3.samvaad.pro'
    ...
    _loadConference() {
        ...
        const { isFaceRecognition, isBreakoutRoomsCreated, breakoutRoomsList, isEnabledParticipantAudioControl } = this.props._participantData;
    ...
    _navigateToHome(event: Event, room: ?string, serverURL: ?string) {
        ...
        const samvaadURl = 'https://dev.dhanushsamvaad.com/samvaad/';
        const homeURL = this.props._userDetails.domainURL.includes('dev');

        //After logout redirect to samvaadpro home page 
        // return window.location.href = homeURL ? samvaadURl : 'https://www.samvaadpro.com/';
...
function _mapStateToProps(state: Object) {
    return {
        ...
        // _domain_URL: state.welcome.participantData.domain_URL
